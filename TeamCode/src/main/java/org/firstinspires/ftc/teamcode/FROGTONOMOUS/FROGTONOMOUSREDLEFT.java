...
@Autonomous
@Configurable
public class FROGTONOMOUSREDLEFT extends CommandOpMode {
    ...
    public void buildPaths() {
        ...
        eat6setup = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-45.308, 86.131), new Pose(144-43.795, 57.639))
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
        ...
        eat6 = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-43.795, 57.639), new Pose(144-19.317, 57.463))
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
        ...
        shoot9 = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-19.317, 57.463), new Pose(144-45.308, 86.131))
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
        ...
        eat9setup = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-45.308, 86.131), new Pose(144-43.944, 37.234))
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
        ...
        eat9 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-43.944, 37.234), new Pose(144-18.841, 37.234))
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
        ...
        shoot12 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-18.841, 37.234), new Pose(144-45.308, 86.131))
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
    }
