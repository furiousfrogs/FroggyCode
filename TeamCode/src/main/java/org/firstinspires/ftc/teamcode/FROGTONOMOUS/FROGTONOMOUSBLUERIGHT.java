...
@Autonomous
@Configurable
public class FROGTONOMOUSBLUERIGHT extends CommandOpMode {
    ...
    public void buildPaths() {
        ...
        eat6 = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(43.795, 59), new Pose(17.317, 59))
                )
                .setConstantHeadingInterpolation(Math.toRadians(180))
                .build();
    ...
    public void initialize() {
        ...
        SequentialCommandGroup froggyroute = new SequentialCommandGroup(
                ...
                new ParallelDeadlineGroup(
                        new FollowPathCommand(follower, eat3, true, 0.8),
...
//
                new ParallelDeadlineGroup(
                        new FollowPathCommand(follower, eat6, true, 0.8),
